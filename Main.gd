...
const DiceRestSquareScenePath: String = "res://all_dice/dice_rest_square.tscn"
const testDialogPath: String = "res://event_dialog.tscn"
...
func _ready():
	...
	Resources.connect("resource_updated", Callable(self, "_on_resource_updated"))
	dice_rest.connect("is_night", Callable(self, "start_night"))
